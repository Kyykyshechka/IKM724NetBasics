...
namespace FurnaceControlSystem
{
    class Program
	{
        ...
        static async Task Main(string[] args)
        {
            ...
            var sensorFactories = new Dictionary<string, Func<Sensor>>
            {
                ...
                {"Pressure",() => new PressureSensor("Pressure", "No description") },
                {"FlowMeter",() => new FlowMeter("FlowMeter", "No description") },
            };
        ...
        private static double GenerateValue(double targetValue, double currentValue, IndicatorModel indicatorModel)
        {
            ...
            var value = furnace.Sensors.FirstOrDefault(x => x.Name == indicatorModel.Name);
